module.exports = {
  ...
  rules: {
    ...
    "comma-dangle": "off", // 마지막에 ,(쉼표)를 넣어주지 않는다.
    ...
    "react-a11y/anchor-is-vaild": "off", // next js에서는 a에 href없이 사용
    "global-require": "off", // 함수 내에서 require 사용 가능
    "react/jsx-filename-extension": [
      1,
      { extentions: [".js", ".jsx", ".tsx"] }, // jsx 사용 가능한 확장자 설정
    ],
    "import/extensions": [
      "error",
      "ignorePackages",
